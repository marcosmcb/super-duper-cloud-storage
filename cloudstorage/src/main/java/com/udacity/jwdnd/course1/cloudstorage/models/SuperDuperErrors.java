...
public class SuperDuperErrors implements BindingResult {

    private List<FieldError> fieldErrors;

    public SuperDuperErrors(Set<ConstraintViolation<File>> violations) {
        this.fieldErrors = new ArrayList<>();
        for (ConstraintViolation violation : violations) {
            this.fieldErrors.add(new FieldError(violation.getInvalidValue().toString(), violation.getPropertyPath().toString(), violation.getMessage()));
        }
    }
